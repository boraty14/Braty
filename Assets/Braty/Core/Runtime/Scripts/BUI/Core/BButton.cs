...
namespace Braty.Core.Runtime.Scripts.BUI.Core
{
    ...
    {
        public float ClickDurationThreshold = 0.5f;
        ...
        private const float ClickDeltaThreshold = 0.1f;
        ...
        public override void MouseDragEvent(Vector2 mousePosition)
        {
            ...
            if (!_isMouseDown) return;
            if (Vector2.Distance(_mouseDownPosition, mousePosition) > ClickDeltaThreshold) ExitClickState();
